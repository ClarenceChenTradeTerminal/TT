...
sub = '/data/market_maker/datafolder/' # data folder
...
logging.basicConfig(filename="logfile.log", format='%(asctime)s %(message)s', filemode='w', level=logging.INFO)
...
all_tickers = ['DOGEUSDT', 'MATICUSDT', 'XLMUSDT', 'BNBUSDT', 'XRPUSDT', 'BCHUSDT', 'BTCUSDT', 'MANAUSDT', 'ETHUSDT', 'FTMUSDT', 'TRXUSDT', 'ADAUSDT', 'LINKUSDT', 'MKRUSDT', 'CHZUSDT', 'ETCUSDT', 'EOSUSDT', 'AVAXUSDT', 'GRTUSDT', 'SOLUSDT', 'VETUSDT', 'LDOUSDT', 'AXSUSDT', 'FILUSDT']
